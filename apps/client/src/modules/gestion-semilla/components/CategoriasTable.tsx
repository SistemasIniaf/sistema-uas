...
import { CategoriaActions } from "./GestionSemillaActions"
import { CategoriaCreateDialog } from "./CategoriaDialog"
import { useCategorias } from "../hooks/useGestionSemilla"
...
const columns: ColumnDef<Categoria>[] = [
  ...
  },
  {
    id: "actions",
    header: "",
    cell: ({ row }) => <CategoriaActions categoria={row.original} />,
  },
]
...
export function CategoriasTable() {
  ...
  const { data, isLoading, isFetching } = useCategorias({
